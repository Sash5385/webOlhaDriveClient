        ...
        <section className="lsection">
          ...
          <div className="contacts">
            <div className="contact-icon-row">
              <a href="tel:+380633855305" className="contact-icon-btn contact-icon-btn--call" aria-label="Зателефонувати">
              ...
              <a href="viber://chat?number=%2B380633855305" className="contact-icon-btn contact-icon-btn--viber" aria-label="Viber">
              ...
              <a href="https://wa.me/380633855305" target="_blank" rel="noreferrer" className="contact-icon-btn contact-icon-btn--wa" aria-label="WhatsApp">
